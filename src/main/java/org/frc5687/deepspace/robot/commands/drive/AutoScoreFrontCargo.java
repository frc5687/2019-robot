...
public class AutoScoreFrontCargo extends CommandGroup {
    public AutoScoreFrontCargo(Robot robot, int starting, boolean left) {
        ...
        addSequential(new AutoDrivePath(robot.getDriveTrain(), robot.getIMU(), robot.getLimelight(), robot.getPoseTracker(), start +"To" + mid, 80));
        ...
        addSequential(new PointClaw(robot.getHatchIntake()));
        addSequential(new AutoDrivePath(robot.getDriveTrain(), robot.getIMU(), robot.getLimelight(), robot.getPoseTracker(), mid + "To" + end, 80));
        addSequential(new GripClaw(robot.getHatchIntake()));
