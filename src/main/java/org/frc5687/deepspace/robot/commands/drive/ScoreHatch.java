...
import org.frc5687.deepspace.robot.commands.AutoDriveToTarget;
import org.frc5687.deepspace.robot.commands.HatchMode;
...
public class ScoreHatch extends CommandGroup {
    public ScoreHatch(Robot robot) {
        ...
        addSequential(new AutoDrive(robot.getDriveTrain(), robot.getIMU(),robot.getHatchIntake(),  -12.00, Constants.Auto.DriveToTarget.MAX_SPEED, true, true, 1000, "Retreat", 1000));
    }
}
