...
public class TwoHatchRocket extends CommandGroup {
    public TwoHatchRocket(Robot robot, boolean OffHAB, boolean left) {
        ...
        addSequential(new AutoDriveToTargetSimple(robot.getDriveTrain(), robot.getIMU(), robot.getOI(), robot.getLimelight(), robot.getLimeLightBot(), robot.getElevator(), robot.getCargoIntake(), robot.getHatchIntake(), robot.getPoseTracker(), .6, false, 0, false));
        addSequential(new PointClaw(robot.getHatchIntake()));
