...
public class AutoScoreRocket extends CommandGroup {
    public AutoScoreRocket(Robot robot, boolean left) {
        ...
        addSequential(new AutoDriveToTargetSimple(robot.getDriveTrain(), robot.getIMU(), robot.getOI(), robot.getLimelight(), robot.getLimeLightBot(), robot.getElevator(), robot.getCargoIntake(), robot.getHatchIntake(), robot.getPoseTracker(), 0.6, false, 0, false));
