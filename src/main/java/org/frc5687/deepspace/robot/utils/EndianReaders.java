...
public class EndianReaders {
     ...
     */
    public static int readU8(I2C device, int i2caddr, int reg){
        ByteBuffer buffer = ByteBuffer.allocate(1);
        boolean rc = device.read(i2caddr, 1, buffer);
...
//        }
     ...
     */
    public static int readS8(I2C device, int i2caddr, int reg){
        ByteBuffer buffer = ByteBuffer.allocate(1);
        boolean rc = device.read(i2caddr, 1, buffer);
    ...
    public static int readU16LE(I2C device, int i2caddr, int register){
        return EndianReaders.readU16(device, i2caddr, register, Endianness.LITTLE_ENDIAN);
    }

    public static int readU16BE(I2C device, int i2caddr, int register){
        return EndianReaders.readU16(device, i2caddr, register, Endianness.BIG_ENDIAN);
    }

    public static int readU16(I2C device, int i2caddr, int register, Endianness endianness){
    ...
    public static int readS16(I2C device, int i2caddr, int register, Endianness endianness){
        int hi = 0, lo = 0;
